      ...
      <ul className="lg:flex">
        <li className="mb-5 lg:w-1/3 lg:pr-3">
          ...
          <p>
            ...
            găsiți un pro care să înțeleagă de ce aveți nevoie și să vă ajute să
            vă atingeți obiectivul. Răsfoiți antrenorii personali în funcție de
            locație sau de diferite servicii.
          </p>
        </li>
