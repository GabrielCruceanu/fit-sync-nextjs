    ...
    <div className="container mx-auto px-4 py-9">
      ...
      <article className="mb-4 text-justify">
        <p>
          ...
          de site-urile <TextLink link="/" target="_self" content="FitSync" />{' '}
          (ex. <TextLink link="/" target="_self" content="www.FitSync.ro" />,{' '}
          <TextLink link="/" target="_self" content="blog.FitSync.ro" />,{' '}
      ...
      <article className="mb-4 text-justify">
        ...
        <ul className="ml-4 mb-3">
          ...
          <li className="list-disc">
            <TextLink
              link="https://support.mozilla.org/en-US/kb/cookies-information-websites-index-on-your-computer?redirectlocale=en-US&redirectslug=Cookies"
              target="_blank"
