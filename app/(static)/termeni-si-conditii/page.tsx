      ...
      <article className="mb-4 text-justify text-gray-100">
        ...
        <ul className="ml-4 mb-3">
          <li className="list-disc">
            <TextLink
              link="https://FitSync.ro"
              target="_blank"
              content="https://FitSync.ro"
            />
          </li>
          <li className="list-disc">
            <TextLink
              link="https://kaapo.ro"
              target="_blank"
              content="https://kaapo.ro"
            />
          </li>
          <li className="list-disc">
            <TextLink
              link="https://kaapo.studio"
              target="_blank"
              content="https://kaapo.studio"
            />
          </li>
        </ul>
      </article>
      ...
      <article className="mb-4 text-justify text-gray-100">
        ...
        <ul className="ml-4 mb-3">
          <li className="list-disc">
            ...
            <TextLink
              link="mailto:contact@kaapo.studio"
              target="_blank"
              content="contact@kaapo.studio"
            />
          </li>
          <li className="list-disc">
            Ne puteți suna:
