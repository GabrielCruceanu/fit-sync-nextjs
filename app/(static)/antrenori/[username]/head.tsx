...
async function getTrainersData() {
  const res = await fetch('https://fitsync.ro/api/trainers');
  ...
  return (
    <>
      <HeadUi
        ...
        description="FitSync este platforma construită pentru antrenorii personali care vor să-și dezvolte afacerea și să managerieze mai ușor clienții online."
      />
    </>
  );
}
