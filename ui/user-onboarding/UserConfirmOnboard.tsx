...
export default function UserConfirmOnboard({
  ...
  return (
    <section className="bg-background py-8 lg:py-0">
      <div className="md:flex md:min-h-[42rem]">
        <div className="mx-auto flex items-center px-4 md:w-[42rem] md:px-8 xl:px-0">
          <div className="w-full">
            ...
            <h1 className="mb-4 text-center text-2xl font-extrabold leading-tight tracking-tight">
              User Confirm
            </h1>
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="w-full items-center rounded-lg border border-input bg-transparent shadow-sm hover:bg-accent hover:text-accent-foreground py-2.5 text-center text-sm font-medium text-gray-400 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-700 sm:py-3.5"
              >
                Anterior
